export default {
  ...
  employeeWork: {
    ...
    subtitle:
      'Гибкая система ролей и прав доступа для всех категорий сотрудников, позволяющая выполнять любые операции и управлять процессами через личный кабинет сотрудника.',
    accessPolicy:
