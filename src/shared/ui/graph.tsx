...
export const Graph = ({ sum = '42,000 ' }) => {
  ...
  return (
    <div className="relative ml-[-4.00px] inline-flex flex-[0_0_auto] flex-col items-start gap-2.5 px-3 py-0">
      <div className="relative size-[var(--size-184)]">
        <div className="relative size-[var(--size-184)]">
          {/* Единый SVG с оригинальными путями и пропорциями */}
          <svg
            width="184"
            height="184"
            viewBox="0 0 184 184"
          ...
          >
            {/* Синий сегмент - оригинальный путь из первого SVG (88x184) */}
            <path
            ...
            {/* Зеленый сегмент - оригинальный путь из второго SVG (88x109) */}
            <path
              ...
              fill="#00CB82"
              transform="translate(96, 75.5)"
            />

            {/* Красный сегмент - оригинальный путь из третьего SVG (22x34) */}
            <path
              ...
              fill="#E74951"
              transform="translate(158, 34)"
            />

            {/* Желтый сегмент - оригинальный путь из четвертого SVG (60x31) */}
            <path
          ...
          {/* Центральный текст */}
          <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-0.5">
