  ...
  return (
    <div className="relative ml-[-4.00px] inline-flex flex-[0_0_auto] flex-col items-start gap-2.5 px-3 py-0">
      <div className="relative size-[var(--size-184)]">
        <div className="relative h-[var(--size-184)]">
          <div className="absolute left-0 top-0 size-[var(--size-184)]">
            <svg
              width="88"
              height="184"
              viewBox="0 0 88 184"
              ...
              className="h-[var(--size-184)]w-1/2 absolute left-0 top-0"
            >
              <path
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              preserveAspectRatio="xMidYMid meet"
              className="h-[58.7%]w-1/2 absolute left-1/2 top-[41.3%]"
            >
              <path
            ...
            <div className="m-auto flex size-full flex-col items-center justify-center gap-0.5">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            preserveAspectRatio="xMidYMid meet"
            className="absolute left-[85.9%] top-[18.5%] h-[18.5%] w-[11.4%]"
          >
            <path
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            preserveAspectRatio="xMidYMid meet"
            className="absolute left-1/2 top-0 h-[16.8%] w-[32.1%]"
          >
            <path
