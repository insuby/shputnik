            ...
            <div className="group flex w-full h-[520px] items-start gap-4 relative">
                ...
                >
                    <div className="inline-flex flex-col items-start gap-6 relative flex-[0_0_auto]">
                        <p id="animate_12_left"
                           className="w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-gray-90 text-[40px] leading-10 relative tracking-[0]">
              <span className="font-medium text-[#1c222f] leading-[0.1px]">
                ...
                кредитование
                    ...
                    <div
                        className="inline-flex items-center gap-2.5 p-4 relative flex-[0_0_auto] bg-white rounded-[100px]">
                        <svg
                            width="32"
                            height="32"
                            viewBox="0 0 32 32"
                    ...
                    <div className="relative w-[690px] h-[548px]">
                        ...
                        >
                            <div
                                ...
                                <div
                                    ...
                                    <div className="flex flex-col w-64 items-start gap-2 relative flex-[0_0_auto]">
                                        ...
                                        <div className="relative self-stretch w-full h-6">
                                            <div
                                                className="absolute -top-px left-0 font-normal text-[#7a86a2] text-base leading-6 whitespace-nowrap [font-family:'Roboto',Helvetica] tracking-[0]">
                                                0
                                            </div>

                                            <div
                                                className="absolute -top-px left-[131px] font-medium text-gray-90 text-base leading-6 whitespace-nowrap [font-family:'Roboto',Helvetica] tracking-[0]">
                                                122 000
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col w-64 items-start gap-2 relative flex-[0_0_auto]">
                                        ...
                                        <div className="relative self-stretch w-full h-6">
                                            ...
                                            <div
                                                className="absolute -top-px left-20 font-medium text-gray-90 text-base leading-6 whitespace-nowrap [font-family:'Roboto',Helvetica] tracking-[0]">
                                                14
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                                    <div
                                        ...
                                        <div
                                            className="w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-[#7a86a2] text-base leading-6 whitespace-nowrap relative tracking-[0]">
                                            Сумма
                                        </div>

                                        <div
                                            className="relative w-fit mr-[-2.33px] font-medium text-gray-90 text-base leading-6 whitespace-nowrap [font-family:'Roboto',Helvetica] tracking-[0]">
                                            42 000₽
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="relative w-fit mr-[-0.33px] font-medium text-gray-90 text-base leading-6 whitespace-nowrap [font-family:'Roboto',Helvetica] tracking-[0]">
                                            14 дней
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="w-fit font-medium text-gray-90 text-base leading-6 whitespace-nowrap relative [font-family:'Roboto',Helvetica] tracking-[0]">
                                            2.5%
                                        </div>
                                    </div>
                                </div>
                            ...
                            <button onClick={onClick}
                                    className="all-[unset] box-border flex h-12 gap-8 px-8 py-3 self-stretch w-full bg-gray-90 rounded-3xl items-center justify-center relative">
                                <div
                                    className="self-stretch w-[164px] mt-[-1.00px] [font-family:'Roboto',Helvetica] font-medium text-white text-base text-center leading-6 whitespace-nowrap relative tracking-[0]">
                                    Оформить займ
                                </div>
                            </button>
                        </motion.div>
                        ...
                        >
                            ...
                            <div
                                ...
                                <div className="inline-flex items-center gap-3 relative flex-[0_0_auto]">
                                    ...
                                    <div
                                        className="w-[72px] mt-[-1.00px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-sm text-right leading-5 relative tracking-[0]">
                                        48,456₽
                                    </div>
                                </div>
