        ...
        <div className="flex flex-col items-start justify-center gap-5 relative flex-1 self-stretch grow">
          ...
          >
            <div className="flex flex-col items-start gap-2 relative flex-1 grow">
              ...
              <p className="self-stretch [font-family:'Roboto',Helvetica] font-normal text-gray-40 text-xl leading-7 relative tracking-[0]">
                Программное обеспечение для запуска P2P-платформы кредитования, обеспечивая прямое взаимодействие между заёмщиками и инвесторами без посредников. Подходит для кредитования ЮЛ и ФЛ
              </p>
            </div>
          ...
          >
            <div className="flex flex-col items-start gap-2 relative flex-1 grow">
              ...
              <p className="self-stretch [font-family:'Roboto',Helvetica] font-normal text-gray-40 text-xl leading-7 relative tracking-[0]">
                Платформа для исламского кредитования — поддержка продуктовых моделей, соответствующих шариатским нормам (мурабаха, иджара, таваруд и др.)
              </p>
            </div>
