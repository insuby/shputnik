      ...
      <div className="relative flex h-[520px] w-full items-start gap-4">
        <div className="relative w-[686px] self-stretch overflow-hidden rounded-[32px] bg-[#f9fafd]">
          <div className="relative h-[682px]">
            <img
              className="absolute left-0 top-0 h-[520px] w-[686px]"
              alt="Vector"
            ...
            <motion.div
              ...
              transition={{ duration: 0.7, ease: 'easeOut' }}
              className="absolute left-[62px] top-[66px] flex w-[304px] flex-col items-center justify-center overflow-hidden rounded-[32px] bg-green-50"
            >
              <div className="relative flex w-full flex-[0_0_auto] flex-col items-center justify-center gap-5 self-stretch p-5">
                <img
                  className="absolute left-[-49px] top-3 h-[330px] w-[345px]"
                  alt="Vector"
            ...
            <img
              className="absolute left-[57px] top-0 h-[520px] w-[629px]"
              alt="Vector"
