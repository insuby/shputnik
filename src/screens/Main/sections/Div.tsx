  ...
  return (
    <div className="flex flex-col items-start gap-8 relative self-stretch w-full flex-[0_0_auto]">
      <p className="w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-gray-90 text-[40px] leading-10 relative tracking-[0]">
        <span id="animate_20" className="font-medium text-[#9ea7bb] leading-[0.1px]">
         Кредитование
          <br />
        </span>

        <span id="animate_21" className="font-medium text-[#1c222f] leading-[48px]">
      ...
      <div className="h-[600px] items-start gap-5 flex relative self-stretch w-full">
        <div className="flex items-center gap-5 relative flex-1 self-stretch grow">
          <div id="animate_24" className="flex flex-col items-start justify-center relative flex-1 self-stretch grow bg-[#f9fafd] hover:bg-[#f5f7ff] cursor-pointer border-2 border-solid hover:border-[#3573fc] border-transparent  rounded-[32px] overflow-hidden">
            <div className="relative flex-1 self-stretch w-full grow rounded-[32px] overflow-hidden">
              <div className="relative w-[678px] h-[401px]">
                ...
                <div id="animate_25" className="inline-flex items-center p-4 absolute top-12 left-12 bg-white rounded-[32px]">
                ...
                <div id="animate_27" className="inline-flex items-center gap-4 pl-4 pr-6 py-4 absolute top-[238px] left-[363px] bg-white rounded-[32px]">
            ...
            <div className="flex items-end gap-8 p-10 relative self-stretch w-full flex-[0_0_auto]">
              <div className="flex flex-col items-start gap-2 relative flex-1 grow">
                <div id="animate_28" className="mt-[-1.00px] [font-family:'Roboto',Helvetica] font-medium text-2xl leading-8 relative self-stretch text-gray-90 tracking-[0]">
                  BNPL
                </div>

                <p  id="animate_30" className="self-stretch [font-family:'Roboto',Helvetica] font-normal text-gray-40 text-xl leading-7 relative tracking-[0]">
          ...
          <div id="animate_22" className="flex flex-col items-start justify-center relative flex-1 self-stretch grow bg-[#f9fafd] hover:bg-[#f5f7ff] cursor-pointer border-2 border-solid hover:border-[#3573fc] border-transparent  rounded-[32px] overflow-hidden">
            <div className="relative flex-1 self-stretch w-full grow rounded-[32px] overflow-hidden">
              <div className="relative w-[543px] h-[416px] top-6 left-[67px]">
                ...
                <div id="animate_26" className="inline-flex flex-col items-start justify-center gap-4 p-8 absolute top-[26px] left-[215px] bg-white rounded-[32px]">
                  <div className="inline-flex flex-col items-start gap-1 relative flex-[0_0_auto]">
                ...
                <div id="animate_23" className="inline-flex gap-3 p-4 top-14 left-0 bg-white rounded-[32px_32px_0px_0px] flex-col items-center justify-center absolute">
            ...
            <div className="flex items-end gap-8 p-10 relative self-stretch w-full flex-[0_0_auto]">
              <div className="flex flex-col items-start gap-2 relative flex-1 grow">
                <div  id="animate_29" className="mt-[-1.00px] [font-family:'Roboto',Helvetica] font-medium text-2xl leading-8 relative self-stretch text-gray-90 tracking-[0]">
                  POS-кредитование
                </div>

                <p  id="animate_31" className="self-stretch [font-family:'Roboto',Helvetica] font-normal text-gray-40 text-xl leading-7 relative tracking-[0]">
