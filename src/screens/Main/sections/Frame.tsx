    ...
    return (
        <div className="w-full overflow-hidden rounded-[24px] bg-[#ffffff] md:rounded-[32px]">
            <div
                ...
                <div
                    className="relative flex w-full max-w-[980px] flex-col items-center justify-center gap-4 px-0 md:gap-7 md:px-0">
                    <motion.h1
                        id="animate_1"
                        ref={refs[0]}
            ...
            <span className="font-medium text-[#1c222f] md:leading-[56px] xl:leading-[68px]">
              ...
              {t('hero.titleC')}
                ...
                <motion.div
                    ...
                    transition={{duration: 0.7, delay: delays[2] + 0.05, ease: 'easeOut'}}
                    className="absolute left-[540px] bottom-[-6px] hidden w-[400px] flex-col gap-4 rounded-t-[40px] border-[6px] border-solid border-gray-90 bg-white p-7 md:flex"
                >
                    <div className="flex w-full items-center justify-between">
                        <div
                            className="text-[24px] font-semibold leading-[32px] text-gray-90 [font-family:'Inter',Helvetica]">
                    ...
                    <div
                        className="flex w-full flex-col gap-4 rounded-[32px] bg-[#F2F5FF] p-6">
                        <div className="flex w-full items-stretch gap-4">
                            <div
                                className="flex size-[140px] items-center justify-center rounded-2xl bg-white p-4 bg-cover bg-center" style={{
                                    backgroundImage: "url('/img/Frame 1948755022.png')"
                            }}/>
                            <div
                                className="relative flex  size-[140px] items-center justify-center gap-4 rounded-2xl bg-white p-4">
                                <div className="absolute -top-2 right-0 -translate-x-1/2">
                                    <CheckIcon className="inline-flex items-center justify-center rounded-[100px] p-1.5"
                                               bgColor="#00CB82" iconColor="#FFFFFF"/>
                                </div>
                                ...
                                <div className="flex w-full flex-col items-center justify-around gap-3">
                                    ...
                                    <div
                                        className="text-[28px] text-center font-medium leading-10 text-gray-90 [font-family:'Roboto',Helvetica]">
                            ...
                            <div className="flex size-[140px] items-center justify-center rounded-2xl bg-white p-4">
                                <svg width="112" height="92" viewBox="0 0 112 92" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="url(#paint0_linear_8964_128)" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round"/>
                                    <defs>
                                        <linearGradient id="paint0_linear_8964_128" x1="-1.78" y1="71.96" x2="114.319"
                                                        y2="72.6227" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#3573FC" stop-opacity="0"/>
                                            <stop offset="0.29049" stop-color="#3573FC"/>
                                            <stop offset="0.685619" stop-color="#3573FC"/>
                ...
                >
                    <div
                        className="relative inline-flex flex-[0_0_auto] items-center justify-center gap-7 rounded-3xl bg-[#f2f5ff] p-4">
                    ...
                    <div className="relative inline-flex flex-[0_0_auto] flex-col items-start gap-1">
                        <div
                            className="relative mt-[-1.00px] w-fit whitespace-nowrap text-sm font-normal leading-5 tracking-normal text-gray-40 [font-family:'Roboto',Helvetica]">
                ...
                >
                    ...
                    <div
                        className="relative inline-flex flex-[0_0_auto] flex-col items-start justify-between self-stretch rounded-[20px] bg-[#f6f8ff] p-5">
                        <div className="relative inline-flex flex-[0_0_auto] items-center gap-3">
                            <div className="relative size-2 rounded bg-blue-50"/>

                            <div
                                className="relative mt-[-1.00px] w-full text-sm font-normal leading-5 tracking-normal text-[#7a86a2] [font-family:'Roboto',Helvetica] md:w-[72px]">
                                {t('chart.current')}
                            </div>

                            <div
                                className="relative mt-[-1.00px] w-full text-right text-sm font-medium leading-5 tracking-normal text-gray-90 [font-family:'Roboto',Helvetica] md:w-[72px]">
                                23,456₽
                            </div>
                        </div>
                ...
                >
                    <div className="relative flex w-full flex-[0_0_auto] flex-col items-start gap-2 self-stretch">
                        <div
                            className="w/full relative flex flex-[0_0_auto] flex-col items-start gap-6 self-stretch p-4">
                            <div
                                className="w/full relative flex flex-[0_0_auto] flex-col items-start gap-1 self-stretch">
                                <div className="w/full relative flex h-6 items-center justify-between self-stretch">
                                    <div
                                        className="relative w-fit whitespace-nowrap text-base font-normal leading-6 tracking-normal text-[#7a86a2] [font-family:'Roboto',Helvetica]">
                                        {t('calculator.amount')}
                                    </div>

                                    <div
                                        className="relative w-fit whitespace-nowrap text-base font-medium leading-6 tracking-normal text-gray-90 [font-family:'Roboto',Helvetica]">
                                        42 000₽
                                    </div>
                                </div>
