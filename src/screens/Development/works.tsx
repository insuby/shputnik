...
export const Works = () => {
    ...
    const inViews = refs.map((ref) => useInView(ref, {margin: '-100px'}));
    ...
    return (
        <div className="flex flex-col items-start gap-12 relative self-stretch w-full flex-[0_0_auto]">
            ...
            <div className="flex w-[1376px] h-[648px] items-center gap-6 relative flex-[0_0_auto] rounded-3xl">
                <div className="relative flex-1 self-stretch grow bg-[#f9fafd] rounded-[32px] overflow-hidden">
                    ...
                    >
                        <div className="px-3 overflow-hidden">
                            <div
                                className="relative w-full h-[1035px] top-[-98px] left-[-231px] bg-[url(https://c.animaapp.com/mdzmydbo2FidHJ/img/vector-1-3.svg)] bg-[100%_100%]">
                                <img
                ...
                <div
                    className="flex flex-col h-[648px] items-start justify-between pl-12 pr-[68px] py-12 relative flex-1 grow rounded-3xl overflow-hidden">
                    {currentSlideIndex + 1 === 3 && (
                        <div className="inline-flex flex-col items-start gap-8 relative flex-[0_0_auto]">
                            ...
                            <p className="w-[560px] font-normal text-[#9ea7bb] text-xl leading-7 relative [font-family:'Roboto',Helvetica] tracking-[0]">
                                Создали мультиплатформенное VPN-решение с упором на конфиденциальность, скорость и
                                стабильность подключения. Интеграция с крипто-оплатами, управление подписками, выбор
                                стран и автоматическое подключение — всё в удобном мобильном приложении.
                            </p>
                        </div>
                    )}
                    ...
                    {currentSlideIndex + 1 === 2 && (
                        <div className="inline-flex flex-col items-start gap-8 relative flex-[0_0_auto]">
                            ...
                            <p className="w-[560px] font-normal text-[#9ea7bb] text-xl leading-7 relative [font-family:'Roboto',Helvetica] tracking-[0]">
                                Децентрализованная платформа для безопасных сделок с крипто-активами. Реализовали
                                Web3-приложение с подключением через TronLink, созданием сделок между пользователями и
                    ...
                    <div
                        className="flex items-center justify-between  self-stretch w-full flex-[0_0_auto] mt-20 bottom-[-80px] pr-10">
                        <div
