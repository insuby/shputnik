    ...
    return (
        <main
            ...
            <div className="flex flex-col w-[560px] items-start gap-4 relative flex-[0_0_auto]">
                ...
                <p className="self-stretch font-body-1-r font-[number:var(--body-1-r-font-weight)] text-[#939db4] text-[length:var(--body-1-r-font-size)] leading-[var(--body-1-r-line-height)] relative tracking-[var(--body-1-r-letter-spacing)] [font-style:var(--body-1-r-font-style)]">
                                ...
                                <AccordionContent>
                                    <CardContent
                                        ...
                                        <div className="flex items-center gap-6">
                                            <Button
                                                className="px-6 py-3 rounded-[100px] bg-blue-50 h-[60px] "
                                                onClick={onClick}>
                          <span
                              className="w-fit mt-[-1.00px] text-[length:var(--body-2-r-font-size)] leading-[var(--body-2-r-line-height)] whitespace-nowrap relative font-body-2-r font-[number:var(--body-2-r-font-weight)] text-white tracking-[var(--body-2-r-letter-spacing)] [font-style:var(--body-2-r-font-style)]">
                            Откликнуться
                          </span>
                                            </Button>
                                        </div>
