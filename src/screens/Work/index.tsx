            ...
            <div className="relative inline-flex w-full flex-[0_0_auto] flex-col items-start gap-4">
                ...
                >
                    {jobListings.map((job) => (
                        ...
                        >
                            <Card
                                className="w-full rounded-3xl bg-white md:w-[1216px]"
                                asChild
                            >
                                <article aria-labelledby={`${job.id}-title`}>
                                    ...
                                    <AccordionContent>
                                        <CardContent
                                            className="mb-4 flex flex-col items-start gap-7 rounded-b-[32px] border-t border-solid border-gray-20 bg-gray-10 p-6">
                                            ...
                                            <div className="flex w-full items-center gap-6">
                                                ...
                                                >
                          <span
                              className="relative mt-[-1.00px] w-full whitespace-nowrap text-[length:var(--body-2-r-font-size)] font-[number:var(--body-2-r-font-weight)] leading-[var(--body-2-r-line-height)] tracking-[var(--body-2-r-letter-spacing)] text-white [font-style:var(--body-2-r-font-style)] md:w-fit">
                            {t('apply')}
                          </span>
                                                </Button>
                                            </div>
