                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="relative mr-[-0.11px] flex w-full md:w-[173.69px] flex-[0_0_auto] flex-col items-start gap-[5.43px]">
                                            <img
                    ...
                    <div className="relative h-[420px] w-full self-stretch overflow-hidden rounded-[32px] bg-blue-50">
                        <div className="absolute left-[-222px] top-[-255px] h-[904px] w-full md:w-[1114px]">
                            ...
                            <div
                                ...
                                <div
                                    className="relative flex w-full md:w-[289px] flex-col items-start gap-[17.55px] self-stretch p-[21.94px]">
                                    <div
                                        className="relative mt-[-0.55px] self-stretch text-[17.5px] font-medium leading-[21.9px] tracking-normal text-gray-90 [font-family:'Roboto',Helvetica]">
                                        Выберите условия
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="relative mx-[-1.10px] mt-[-1.10px] flex w-full md:w-[247.32px] flex-[0_0_auto] items-start justify-end gap-[8.77px] rounded-[8.77px] border-[1.1px] border-solid border-[#3573fc] bg-white p-[13.16px]">
                                            <div
                                        ...
                                        <div
                                            className="relative flex w-full md:w-[245.13px] flex-[0_0_auto] items-start justify-end gap-[8.77px] rounded-[8.77px] bg-white p-[13.16px]">
                                            <div
