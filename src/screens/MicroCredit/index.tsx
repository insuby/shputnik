      ...
      <div className="flex flex-col items-start gap-8 relative self-stretch w-full flex-[0_0_auto]">
        <div
          ...
          >
            ...
            >
              <div
                className="[font-family:'Roboto',Helvetica] text-gray-90 text-xl leading-7 relative w-fit mt-[-1.00px] font-normal tracking-[0] whitespace-nowrap">
                Демо-версия
              </div>
            </button>
          </motion.div>
          ...
          <div className="inline-flex items-center gap-6 relative flex-[0_0_auto] mr-[-468.00px]">
            ...
            >
              ...
              <div className="relative flex-1 self-stretch w-full grow">
                <div
                  className="inline-flex relative top-[27px] left-10 flex-col items-center justify-center gap-6 p-4 bg-[#ffffff] rounded-[32px]">
            ...
            >
              ...
              <div className="relative flex-1 self-stretch w-full grow">
                <div className="relative w-[290px] h-24 top-[26px] left-7">
                  ...
                  <div
                    ...
                    <div
                      className="relative flex-1 [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-base tracking-[0] leading-6">
                      Ваша заявка одобрена
                    </div>
                  </div>

                  <div
                    className="flex w-[290px] items-center justify-center gap-4 p-2 absolute top-0 left-0 bg-[#ffffff] rounded-[32px]">
                    <div
                      className="inline-flex items-center justify-center gap-2.5 p-2.5 relative flex-[0_0_auto] bg-[#fbab0014] rounded-[100px]">
                      <img
                        className="relative w-6 h-6"
              ...
              <div className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto]">
                ...
                <p
                  className="relative self-stretch [font-family:'Roboto',Helvetica] font-normal text-[#9ea7bb] text-xl text-center tracking-[0] leading-7">
                  Система автоматически отправляет уведомления клиентам о статусе
                  заявки, одобрении, выдаче займа и напоминания о платежах.
                </p>
              </div>
            </motion.div>
          </div>
