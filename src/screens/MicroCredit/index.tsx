    ...
    return (
        <div
            ...
            <div className="flex flex-col items-start gap-8 relative self-stretch w-full flex-[0_0_auto]">
                <div
                    className="flex flex-col h-[600px] items-start gap-20 p-12 relative self-stretch w-full bg-violet-50 rounded-[32px] overflow-hidden">
                    <img
                    ...
                    >
                        <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                            <div
                                ...
                                <div className="flex flex-col w-64 items-start gap-2 relative flex-[0_0_auto]">
                                    ...
                                    <div className="relative self-stretch w-full h-6">
                                        ...
                                        <div
                                            className="absolute -top-px left-[131px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-base tracking-[0] leading-6 whitespace-nowrap">
                                            122 000
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-2 self-stretch w-full relative flex-[0_0_auto]">
                                <div
                                    className="flex flex-col items-start px-4 py-3 relative flex-1 grow bg-[#f6f8ff] rounded-[20px]">
                                    <div
                                        className="relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-[#7a86a2] text-base tracking-[0] leading-6 whitespace-nowrap">
                                        Сумма
                                    </div>

                                    <div
                                        className="relative w-fit mr-[-2.33px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-base tracking-[0] leading-6 whitespace-nowrap">
                                        42 000₽
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        className="relative w-fit mr-[-0.33px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-base tracking-[0] leading-6 whitespace-nowrap">
                                        14 дней
                                    </div>
                                </div>
                            ...
                            >
                                <div
                                    className="self-stretch w-[164px] mt-[-1.00px] font-medium text-[#ffffff] text-base text-center leading-6 whitespace-nowrap relative [font-family:'Roboto',Helvetica] tracking-[0]">
                                    Оформить займ
                                </div>
                            </button>
                        </div>
                    ...
                    >
                        ...
                        <div
                            ...
                            <div className="inline-flex items-center gap-3 relative flex-[0_0_auto]">
                                ...
                                <div
                                    className="relative w-[72px] mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-[#7a86a2] text-sm tracking-[0] leading-5">
                                    Текущее
                                </div>

                                <div
                                    className="relative w-[72px] mt-[-1.00px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-sm text-right tracking-[0] leading-5">
                                    48,456₽
                                </div>
                            </div>
                                ...
                                <div className="px-3">
                                    <div
                                        ...
                                        <div className="relative flex-1 self-stretch w-full grow">
                                            <div
                                                className="inline-flex flex-col gap-6 p-4 relative top-[27px] left-10 items-center justify-center bg-[#ffffff] rounded-[32px]">
                                                <div
                                                    className="flex flex-col w-[230px] items-start gap-5 pt-3 pb-0 px-4 relative flex-[0_0_auto]">
                                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                className="self-stretch mt-[-1.00px] text-2xl text-center leading-8 relative [font-family:'Roboto',Helvetica] font-medium text-gray-90 tracking-[0]">
                                                Подача заявок
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div className="relative flex-1 self-stretch w-full grow">
                                            <div className="relative w-[290px] h-24 top-[26px] left-7">
                                                <div
                                                    className="flex w-[235px] items-center justify-center gap-4 p-2 absolute top-7 left-7 bg-[#ffffff] rounded-[32px] opacity-[0.24]">
                                                    <div
                                                        className="inline-flex items-center justify-center gap-2.5 p-2.5 relative flex-[0_0_auto] bg-[#fbab0014] rounded-[100px]">
                                                        <div
                                                            className="mt-[-1968.00px] ml-[-7711.00px] opacity-0 relative w-6 h-6 bg-[100%_100%]">
                                                            <div
                                                                className="relative w-4 h-[15px] top-[-1968px] left-[-7711px]">
                                                                <img
                                                    ...
                                                    <div
                                                        className="relative flex-1 opacity-0 [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-base tracking-[0] leading-6">
                                                        Ваша заявка одобрена
                                                    </div>
                                                </div>

                                                <div
                                                    className="flex w-[266px] items-center justify-center gap-4 p-2 absolute top-4 left-3 bg-[#ffffff] rounded-[32px] opacity-50">
                                                    <div
                                                        className="inline-flex items-center justify-center gap-2.5 p-2.5 relative flex-[0_0_auto] bg-[#fbab0014] rounded-[100px]">
                                                        <div
                                                            className="mt-[-1954.00px] ml-[-7695.00px] relative w-6 h-6 bg-[100%_100%]">
                                                    ...
                                                    <div
                                                        className="flex-1 text-base leading-6 relative [font-family:'Roboto',Helvetica] font-medium text-gray-90 tracking-[0]">
                                                        Ваша заявка одобрена
                                                    </div>
                                                </div>

                                                <div
                                                    className="flex w-[290px] gap-4 p-2 absolute top-0 left-0 items-center justify-center bg-[#ffffff] rounded-[32px]">
                                                    <div
                                                        className="inline-flex items-center justify-center gap-2.5 p-2.5 relative flex-[0_0_auto] bg-[#fbab0014] rounded-[100px]">
                                                        <div
                                                            className="mt-[-1938.00px] ml-[-7683.00px] relative w-6 h-6 bg-[100%_100%]">
                                                            <div className="relative w-[18px] h-5 top-0.5 left-[3px]">
                                                                <img
                                                                    className="absolute w-2 h-[5px] top-[15px] left-[5px]"
                                                                    alt="Vector"
            ...
            >
                ...
                >
                    <div
                        className="relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-xl tracking-[0] leading-7 whitespace-nowrap">
                        Демонстрация
                    </div>
                </button>
            </motion.div>
