  ...
  return (
    <div className="flex flex-col w-[1440px] items-center gap-[136px] pt-8 pb-[136px] px-8 relative flex-[0_0_auto]">
      <div className="flex flex-col items-start gap-8 relative self-stretch w-full flex-[0_0_auto]">
        <div className="flex flex-col h-[600px] items-start gap-20 p-12 relative self-stretch w-full bg-green-60 rounded-[32px] overflow-hidden">
          <img
          ...
          >
            <div className="flex flex-col items-center justify-center gap-5 p-5 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <div className="inline-flex flex-col items-center relative flex-[0_0_auto]">
                ...
                <div className="relative w-fit [font-family:'Roboto',Helvetica] font-medium text-[#ffffff] text-[28px] text-center tracking-[0] leading-10 whitespace-nowrap">
                  122,000₽
                </div>
              </div>
            ...
            <div className="flex flex-col items-start gap-4 p-2.5 relative self-stretch w-full flex-[0_0_auto] bg-[#ffffff] rounded-3xl">
              <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                <div className="flex h-[72px] items-start gap-4 p-1 relative self-stretch w-full bg-[#f2f5ff] rounded-2xl overflow-hidden">
                  <div className="flex flex-col items-start p-3 relative flex-1 grow">
                    <div className="opacity-50 text-gray-70 text-xs leading-4 relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal tracking-[0] whitespace-nowrap">
                      Мои инвестиции
                    </div>

                    <div className="relative w-fit font-medium text-gray-90 text-base leading-6 [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                      42 000₽
                    </div>
                  </div>

                  <div className="flex flex-col w-[88px] items-start p-3 relative bg-[#eaedf7] rounded-xl">
                    <div className="w-fit opacity-50 font-normal text-gray-70 text-xs leading-4 whitespace-nowrap relative mt-[-1.00px] [font-family:'Roboto',Helvetica] tracking-[0]">
                      Интерес
                    </div>
                ...
                <div className="flex h-[72px] items-start gap-4 p-1 relative self-stretch w-full bg-[#f2f5ff] rounded-2xl">
                  <div className="flex flex-col items-start p-3 relative flex-1 grow">
                    <div className="relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-[#7a86a2] text-xs tracking-[0] leading-4 whitespace-nowrap">
                      Мои займы
                    </div>

                    <div className="w-fit font-medium text-base leading-6 whitespace-nowrap relative [font-family:'Roboto',Helvetica] text-gray-90 tracking-[0]">
                      134 000₽
                    </div>
                  </div>
              ...
              <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                <div className="relative w-fit mt-[-1.00px] [font-family:'Inter',Helvetica] font-normal text-gray-70 text-xs tracking-[0] leading-4 whitespace-nowrap">
                  Инвестиции
                </div>
                ...
                <div className="h-24 items-start gap-4 p-1 self-stretch w-full bg-[#f2f5ff] rounded-2xl flex relative">
                  <div className="flex flex-col items-start gap-2 p-3 relative flex-1 grow">
                    <div className="relative w-fit mt-[-1.00px] font-medium text-gray-90 text-base leading-6 [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                      80 000₽
                    </div>
                    ...
                    <div className="flex items-center gap-3 relative self-stretch w-full flex-[0_0_auto]">
                      <div className="flex flex-col items-start relative flex-1 grow">
                        ...
                        <div className="font-normal text-gray-90 text-xs leading-4 relative w-fit [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                          14%
                        </div>
                      </div>
          ...
          >
            <div className="inline-flex flex-col items-start gap-1 relative flex-[0_0_auto]">
              ...
              <div className="relative w-[264px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-xl tracking-[0] leading-7">
                1,567,000₽
              </div>
            </div>
            ...
            <div className="inline-flex h-[154px] items-end relative">
              <div className="inline-flex flex-col items-center justify-center gap-2.5 relative flex-[0_0_auto]">
                ...
                <div className="w-11 font-normal text-[#7a86a2] text-xs text-center leading-4 relative [font-family:'Roboto',Helvetica] tracking-[0]">
                  01.05
                </div>
              </div>
              ...
              <div className="inline-flex flex-col items-center justify-center gap-2.5 relative flex-[0_0_auto]">
                <div className="h-[120px] bg-[linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(0,203,130,1)_100%)] relative w-8 rounded-3xl" />
            ...
            <div className="inline-flex flex-col items-center justify-center gap-1 p-2 relative top-4 left-[153px] bg-[#ffffff] rounded-[32px_32px_0px_0px] overflow-hidden">
              <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                <div className="flex-col w-[284px] items-center justify-center gap-5 pt-3 pb-2 px-4 flex-[0_0_auto] flex relative">
                  <div className="flex items-center justify-between relative self-stretch w-full flex-[0_0_auto]">
                    <div className="relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-xl text-center tracking-[0] leading-7 whitespace-nowrap">
                      Продукт
                    </div>
                ...
                <div className="flex flex-col w-[284px] items-start gap-4 p-2.5 relative flex-[0_0_auto] rounded-3xl">
                  <div className="inline-flex gap-2 flex-col items-start relative flex-[0_0_auto]">
                    <div className="w-[264px] gap-2 px-4 py-3.5 flex-[0_0_auto] bg-[#f2f5ff] rounded-2xl overflow-hidden flex flex-col items-start relative">
                      <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                      ...
                      <div className="inline-flex flex-col items-start gap-1 relative flex-[0_0_auto]">
                        ...
                        <div className="flex w-[232px] h-4 items-start justify-between relative">
                          <div className="relative w-fit mt-[-1.00px] opacity-50 font-normal text-gray-70 text-xs leading-4 [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                            10 000 ₽
                          </div>
                    ...
                    <div className="w-[264px] gap-2 px-4 py-3.5 flex-[0_0_auto] bg-[#f2f5ff] rounded-2xl overflow-hidden flex flex-col items-start relative">
                      ...
                      <div className="inline-flex flex-col items-start gap-1 relative flex-[0_0_auto]">
                        ...
                        <div className="flex w-[232px] h-4 items-start justify-between relative">
                          <div className="mt-[-1.00px] opacity-50 font-normal text-gray-70 text-xs leading-4 relative w-fit [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                            0%
                          </div>
          ...
          <div className="relative w-[688px] h-[714px] top-5 left-[33px] bg-[url(/img/p2p/vector-1-7.svg)] bg-[100%_100%]">
            <div className="inline-flex flex-col items-center justify-center gap-1 p-2 relative top-5 left-[153px] bg-[#ffffff] rounded-[32px_32px_0px_0px] overflow-hidden">
              <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                ...
                <div className="items-start px-2.5 py-2 self-stretch w-full flex-[0_0_auto] flex relative">
                  <div className="w-[264px] items-center justify-between bg-[#f9fafd] rounded-[100px] flex relative">
                    <div className="flex w-[132px] px-0 py-2 bg-gray-90 rounded-[100px] flex-col items-center justify-center gap-2 relative">
                      <div className="relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-white text-sm tracking-[0] leading-5 whitespace-nowrap">
                        Продукты
                      </div>
                    </div>

                    <div className="flex w-[132px] px-0 py-2 flex-col items-center justify-center gap-2 relative">
                      <div className="relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-gray-90 text-sm tracking-[0] leading-5 whitespace-nowrap">
                        Договоры
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col w-[284px] items-start gap-4 p-2.5 relative flex-[0_0_auto] rounded-3xl">
                  <div className="inline-flex gap-3 flex-col items-start relative flex-[0_0_auto]">
                    <div className="flex w-[264px] items-center justify-between p-3 relative flex-[0_0_auto] bg-[#f9fafd] rounded-2xl overflow-hidden">
                      <div className="inline-flex flex-col items-start gap-1 relative flex-[0_0_auto]">
                        <div className="inline-flex items-center justify-center gap-2.5 px-2 py-1.5 relative flex-[0_0_auto] bg-[#00cb8214] rounded-[100px]">
                      ...
                      <div className="flex-1 [font-family:'Roboto',Helvetica] font-medium text-gray-90 text-base text-right leading-6 relative tracking-[0]">
                        +30 580 ₽
                      </div>
                    </div>

                    <div className="flex w-[264px] items-center justify-between p-3 relative flex-[0_0_auto] bg-[#f9fafd] rounded-2xl overflow-hidden">
                      <div className="inline-flex items-center justify-center gap-2.5 px-2 py-1.5 relative flex-[0_0_auto] bg-[#3573fc14] rounded-[100px]">
                        <div className="w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal text-[#3573fc] text-xs leading-4 whitespace-nowrap relative tracking-[0]">
                          Льготный
                        </div>
                      </div>
                    ...
                    <div className="flex w-[264px] items-center justify-between p-3 relative flex-[0_0_auto] bg-[#f9fafd] rounded-2xl overflow-hidden">
                      <div className="inline-flex items-center justify-center gap-2.5 px-2 py-1.5 relative flex-[0_0_auto] bg-[#e6485014] rounded-[100px]">
      ...
      <div className="flex items-center gap-[88px] p-20 relative self-stretch w-full flex-[0_0_auto] bg-green-60 rounded-[32px] overflow-hidden">
        <img
        ...
        <div className="flex flex-col w-[324px] items-center justify-center gap-6 p-4 absolute top-[102px] left-[810px] bg-white rounded-[32px]">
          <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
            <div className="flex flex-col items-start gap-5 pt-3 pb-4 px-4 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <div className="w-64 gap-2 flex-[0_0_auto] flex flex-col items-start relative">
                ...
                <div className="relative self-stretch w-full h-6">
                  ...
                  <div className="absolute -top-px left-[131px] font-medium text-gray-90 text-base leading-6 [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                    122 000
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
              <div className="px-4 py-3 flex-1 grow bg-[#f6f8ff] rounded-[20px] flex flex-col items-start relative">
                <div className="text-[#7a86a2] text-base leading-6 relative w-fit mt-[-1.00px] [font-family:'Roboto',Helvetica] font-normal tracking-[0] whitespace-nowrap">
                  Сумма
                </div>

                <div className="relative w-fit mr-[-2.33px] font-medium text-gray-90 text-base leading-6 [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                  42 000₽
                </div>
              </div>
              ...
              <div className="px-4 py-3 flex-1 grow bg-[#f6f8ff] rounded-[20px] flex flex-col items-start relative">
                ...
                <div className="relative w-fit mr-[-0.33px] font-medium text-gray-90 text-base leading-6 [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                  14 дней
                </div>
              </div>
              ...
              <div className="px-4 py-3 flex-1 grow bg-[#f6f8ff] rounded-[20px] flex flex-col items-start relative">
                ...
                <div className="font-medium text-gray-90 text-base leading-6 relative w-fit [font-family:'Roboto',Helvetica] tracking-[0] whitespace-nowrap">
                  2.5%
                </div>
              </div>
            </div>
        ...
        <div className="inline-flex flex-col items-center justify-center gap-3 p-4 absolute top-[165px] left-[1054px] bg-white rounded-[32px]">
          ...
          <div className="inline-flex flex-col items-start gap-2.5 p-5 relative flex-[0_0_auto] bg-[#f6f8ff] rounded-[20px]">
            <div className="inline-flex items-center gap-3 relative flex-[0_0_auto]">
              ...
              <div className="w-[72px] mt-[-1.00px] font-normal text-[#7a86a2] text-sm leading-5 relative [font-family:'Roboto',Helvetica] tracking-[0]">
                Текущее
              </div>

              <div className="w-[72px] font-medium text-gray-90 text-sm text-right leading-5 relative mt-[-1.00px] [font-family:'Roboto',Helvetica] tracking-[0]">
                48,456₽
              </div>
            </div>
