    ...
    return (
        <div
            className={cx('relative flex flex-col items-start gap-[88px] ', {
                'bg-[linear-gradient(356deg,rgba(255,255,255,1)_0%,rgba(243,244,250,1)_100%)]': isBgEnabled
            })}
        >
                                                    ...
                                                    <span
                                                        ...
                                                        <svg width="18" height="22"
                                                          ...
                                                          <path fill-rule="evenodd" clip-rule="evenodd"
                                                                ...
                                                                stroke="#1C222F" stroke-width="1.6"
                                                                stroke-linejoin="round"/>
                                                        </svg>
                                                    </span>
                                            <span
                                              ...
                                              className="flex items-center gap-4 h-[80px] p-4">
                                                    <span
                                                        ...
                                                        <svg width="24" height="24"
                                                             ...
                                                             fill="none"
                                                             xmlns="http://www.w3.org/2000/svg">
                                                          <path d="M16.875 3.75H20.25V7.125" stroke="#1C222F"
                                                                stroke-width="1.6" stroke-linecap="round"
                                                                stroke-linejoin="round"/>
                                                          <path d="M16.875 20.25H20.25V16.875" stroke="#1C222F"
                                                                stroke-width="1.6" stroke-linecap="round"
                                                                stroke-linejoin="round"/>
                                                          <path d="M7.125 20.25H3.75V16.875" stroke="#1C222F"
                                                                stroke-width="1.6" stroke-linecap="round"
                                                                stroke-linejoin="round"/>
                                                          <path d="M7.125 3.75H3.75V7.125" stroke="#1C222F"
                                                                stroke-width="1.6" stroke-linecap="round"
                                                                stroke-linejoin="round"/>
                                                          <path
  ...
  <path
      ...
      stroke="#1C222F" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div className="space-y-3 ">
                                    ...
                                    <div
                                        className="divide-y bg-[#F9FBFF] divide-gray-10 rounded-[32px] border border-[#F3F4F7]">
                                        <Link
                      ...
                      <span className="flex items-center gap-3 w-full">
                       ...
                       <span
                           className="text-gray-90 text-[20px] border-b border-solid py-6 border-[#eeeff2] w-10/12">P2P-кредитование</span>
                                        ...
                                        >
                                          <span className="flex items-center gap-3 w-full">
                                            <svg className="size-12" viewBox="0 0 64 64" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                              <rect width="64" height="64" rx="24" fill="#F9FAFD"/>
                                              <path
                                                  ...
                                                  stroke="#01AD7C" strokeWidth="1.6" strokeLinecap="round"
                                                  strokeLinejoin="round"/>
                                              <path
                                            ...
                                            >
                                                <span className="flex items-center gap-3 w-full">
                                                    <svg className="size-12" viewBox="0 0 64 64" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <rect width="64" height="64" rx="24" fill="#F9FAFD"/>
                                                        <path d="M32 34V20" stroke="#725DD6" strokeWidth="1.6"
                                                              strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path d="M43 34V42H21V34" stroke="#725DD6" strokeWidth="1.6"
                                                              strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path d="M27 25L32 20L37 25" stroke="#725DD6" strokeWidth="1.6"
                                                              strokeLinecap="round" strokeLinejoin="round"/>
                                                    </svg>
                                                    <span
                                                        className="text-gray-90 text-[20px] border-b border-solid py-6 border-[#eeeff2] w-10/12">
                                            ...
                                            >
                                                <span className="flex items-center gap-3 w-full">
                                                    <svg className="size-12" viewBox="0 0 64 64" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <rect width="64" height="64" rx="24" fill="#F9FAFD"/>
                                                        <path d="M32 37V44" stroke="#FBAB00" strokeWidth="1.6"
                                                              strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path
                                                            ...
                                                            stroke="#FBAB00" strokeWidth="1.6" strokeLinecap="round"
                                                            strokeLinejoin="round"/>
                                                        <path d="M27.1687 33.295L20.4062 35.1062" stroke="#FBAB00"
                                            ...
                                            >
                                                <span className="flex items-center gap-3 w-full">
                                                    <svg className="size-12" viewBox="0 0 64 64" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <rect width="64" height="64" rx="24" fill="#F9FAFD"/>
                                                        <path d="M24 27L18 32L24 37" stroke="#E74951" strokeWidth="1.6"
                                                              strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path d="M40 27L46 32L40 37" stroke="#E74951" strokeWidth="1.6"
                                                              strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path d="M36 21L28 43" stroke="#E74951" strokeWidth="1.6"
                                                              strokeLinecap="round" strokeLinejoin="round"/>
                                                    </svg>
                        ...
                        <div className="absolute bottom-2 rounded-[32px] p-[8px_8px_8px_0] bg-[#f9fafd] right-3 left-3">
                            <p>+7 (495) 006-21-57</p>
                        </div>
                    </motion.div>
                )}
