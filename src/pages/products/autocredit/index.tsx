...
export const Autocredit = () => {
  ...
  const pageMeta = usePageMeta(PAGE_META.autocredit);
        ...
        <div className="relative flex w-full flex-[0_0_auto] flex-col items-start gap-7 self-stretch">
          <div className="relative flex w-full flex-col items-start gap-20 self-stretch overflow-hidden rounded-[32px] bg-blue-50 p-7 lg:h-[670px] lg:p-12">
            ...
            >
                ...
                <div className="relative flex w-full flex-[0_0_auto] items-center gap-[11.96px] self-stretch rounded-[11.96px] border-[0.75px] border-solid border-[#dbe1f0] p-[11.96px]">
                  ...
                  <div className="relative size-[17.94px] rotate-90">
                    ...
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="absolute left-[3px] top-[5px] h-[7px] w-full -rotate-90 lg:w-[13px]"
                    >
                      <path
              ...
              <div className="relative flex w-full flex-col items-start gap-[23.92px] self-stretch p-[29.9px] lg:w-[393.9px]">
                <div className="relative self-stretch text-[23.9px] font-medium leading-[29.9px] tracking-normal text-gray-90 [font-family:'Roboto',Helvetica]">
                  ...
                  <div className="relative mx-[-1.49px] mt-[-1.49px] flex w-full flex-[0_0_auto] items-start justify-end gap-[11.96px] rounded-[11.96px] border-[1.49px] border-solid border-[#3573fc] bg-[#ffffff] p-[17.94px] lg:w-[337.09px]">
                    <div className="relative flex w-full flex-1 grow flex-col items-center justify-center gap-[11.96px] self-stretch lg:w-auto">
                      <div className="relative flex w-full flex-[0_0_auto] items-center justify-center gap-[7.47px] self-stretch">
                        ...
                        <div className="relative ml-[-13855.74px] mt-[-753.75px] size-[20.93px] bg-[100%_100%]">
                          <svg
                            ...
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-2.5w-full absolute left-[-14133px] top-[-754px] lg:w-[15px]"
                          >
                            <path
                      ...
                      <div className="relative flex w-full flex-[0_0_auto] items-start gap-[17.94px] self-stretch">
                        ...
                        <div className="relative flex w-full flex-col items-start gap-[1.49px] lg:w-[91.19px]">
                          <div className="relative mt-[-0.75px] self-stretch text-[10.5px] font-normal leading-[14.9px] tracking-normal text-[#9ea7bb] [font-family:'Roboto',Helvetica]">
                            {t('form.amount')}
                          </div>
                        ...
                        <div className="relative flex w-full flex-col items-start gap-[1.49px] lg:w-[59.8px]">
                          <div className="relative mt-[-0.75px] self-stretch text-[10.5px] font-normal leading-[14.9px] tracking-normal text-[#9ea7bb] [font-family:'Roboto',Helvetica]">
                            {t('form.rate')}
                          </div>
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              className="relative w-full text-center text-xl font-normal leading-7 tracking-normal text-[#9ea7bb] [font-family:'Roboto',Helvetica] lg:w-[704px]"
            >
