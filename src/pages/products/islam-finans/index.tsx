...
export const IslamFinance = () => {
  ...
  const pageMeta = usePageMeta(PAGE_META.islamFinance);
  ...
  return (
    <>
      ...
      <div className="relative flex w-full flex-[0_0_auto] flex-col items-center gap-[88px] p-0 lg:w-full lg:gap-[136px] lg:px-8 lg:pb-[136px] lg:pt-8">
            ...
            >
              ...
              <div className="relative flex flex-1 grow flex-col items-start gap-5 self-stretch p-6">
                <div className="relative inline-flex flex-[0_0_auto] items-center gap-4">
                  <div className="relative size-12 overflow-hidden rounded-3xl [background:url(/img/Frame-1948755022.png)_50%_50%_/_cover]">
                    <img
        ...
        <ZaimChecker namespace="islamfinance" />
        <Integrations />
        <RoleStructure />
        <Trust />
      </div>
