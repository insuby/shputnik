  ...
  return (
    <div className="relative flex w-full flex-[0_0_auto] flex-col items-center justify-center gap-7 self-stretch md:gap-12">
      ...
      <div className="relative flex w-full flex-[0_0_auto] items-center gap-6 rounded-3xl md:w-[1376px] ">
        ...
        <svg width="676" height="648" viewBox="0 0 676 648" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative hidden flex-1 grow self-stretch md:flex" alt="Frame">

<g clipPath="url(#clip0_9535_12876)">
<rect width="676" height="648" rx="32" fill="#F9FAFD"/>
<g opacity="0.16" filter="url(#filter0_f_9535_12876)">
<path d="M484.735 382.107C555.757 427.87 538.516 534.958 521.017 582.782C351.978 825.354 140.224 535.791 144.257 382.171C148.291 228.551 337.668 24.4999 430.946 84.6037C524.225 144.707 395.957 324.903 484.735 382.107Z" fill="#3573FC"/>
</g>
<rect x="177" y="53" width="168" height="168" rx="84" fill="white" fillOpacity="0.36"/>
...
<path d="M260.893 99.8572V124.75H273.339C280.213 124.75 285.786 119.178 285.786 112.304C285.786 105.43 280.213 99.8572 273.339 99.8572H260.893Z" fill="#FF7262"/>
<path d="M236 112.304C236 119.178 241.572 124.75 248.446 124.75H260.893V99.8572H248.446C241.572 99.8572 236 105.43 236 112.304Z" fill="#F24E1E"/>
<rect x="375" y="81" width="224" height="224" rx="88" fill="white" fillOpacity="0.36"/>
...
<rect x="77" y="234" width="200" height="200" rx="88" fill="white" fillOpacity="0.36"/>
...
<rect x="215" y="447" width="148" height="148" rx="74" fill="white" fillOpacity="0.36"/>
...
<rect x="363" y="321" width="168" height="168" rx="84" fill="white" fillOpacity="0.36"/>
...
<defs>
<filter id="filter0_f_9535_12876" x="-55.8008" y="-126.171" width="792.27" height="1002.24" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
