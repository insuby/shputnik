export const fdata = {
  ...
  static: {
    heroDescription: 'Автоматизация всех ваших процессов обработки финансовых данных с минимальной зависимостью от персонала',
  ...
  details: {
    ...
    philosophy: 'Философия и архитектура f.Data позволяет нашим клиентам уверенно управлять финансовыми данными, делать это быстро и эффективно.',
    lossReduction: 'Сокращение финансовых потерь',
    confidence: 'Собственники бизнеса, CFO, COO, CIO получают уверенность в корректности финансовых данных, передаваемых в отчетность.',
    ...
    testimonials: {
      ...
      quote: 'f.Data легко масштабируется для бизнеса любого размера, что позволяет автоматизировать работу с финансовыми данными как в банках, страховых и инвестиционных компаниях, платежных системах, так и в компаниях среднего и малого бизнеса.',
    },
    final: {
