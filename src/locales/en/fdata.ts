export const fdata = {
  ...
  static: {
    ...
    processMvp: 'MVP',
    processScalability: 'Scalability',
    processScalabilityDescription: 'System scalability',
    processCrossPlatform: 'Cross-platform',
    processCrossPlatformDescription: 'Cross-platform development',
    processHighLoad: 'High loads',
    processHighLoadDescription: 'High load processing',
    processDesign: 'Design',
    processDesignDescription: 'Interface design',
    processPlatforms: 'Platforms',
    processTry: 'Try',
    comfortWorkPlan: 'Work plan',
    comfortWorkPlanDescription: 'Clear work plan',
    comfortTeam: 'Team',
    comfortTeamDescription: 'Professional team',
    comfortReliablePartner: 'Reliable partner',
    comfortReliablePartnerDescription: 'Reliable development partner',
  },
  hero: {
  ...
  details: {
    ...
    speed: {
      title: 'Work faster',
      description: 'Processes with f.Data are performed up to 100 times faster',
    },
  },
  howWeHelp: {
  ...
  ourClients: {
    title: 'Our clients',
    testimonial: {
      name: 'Konstantin Grizov',
      position: 'Managing Partner PLUS Consulting',
      text: 'f.Data easily scales for businesses of any size, allowing you to automate work with financial data both in banks, insurance and investment companies, payment systems, and in medium and small businesses.',
    },
  },
  benefits: {
    controlFinances: {
    ...
    getRidOfErrors: {
      title: 'Get rid of errors',
      description: 'Automatic quality and data integrity checks at all stages',
    },
  },
};
