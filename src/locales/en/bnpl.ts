export const bnpl = {
  ...
  static: {
    ...
    description:
      'We offer ready-made tools for automating BNPL (Buy Now, Pay Later) and POS lending processes. Solutions are suitable for banks, MFIs, fintech companies and retail chains',
    posTitle: 'PoS Lending',
    posDescription:
      'Software product for automating lending online and at points of sale. Allows you to arrange loans with interest rates directly at the checkout, in the office or through an online form.',
  ...
  description: {
    bnpl: 'Software for launching BNPL in online stores. Allows customers to pay for goods in installments. Suitable for e-commerce platforms and financial organizations that want to offer BNPL platform to partner stores.',
    pos: 'Software product for automating lending online and at points of sale. Allows you to arrange loans with interest rates directly at the checkout, in the office or through an online form.',
  },
  process: {
    bnpl: 'BNPL Process',
    pos: 'POS Process',
  ...
  form: {
    ...
    date: 'Date',
    dateValue: 'February 20, 2025',
    payFullAmount: 'Pay Full Amount',
  },
  parameters: {
    title: 'Customizable Parameters',
    personalInfo: 'Personal Information',
    history: 'Previous Issuance History',
  ...
  social: {
    ...
    personalInfo: 'Personal Information',
    bankAndAddress: 'Bank and Address',
    documents: 'Documents',
  },
  verification: {
