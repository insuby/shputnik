...
export const CrmCapabilities = () => {
    ...
    return (
        <motion.div
            ...
            className="relative flex flex-col md:!flex-row w-full flex-[0_0_auto] items-center gap-8 md:gap-2.5 self-stretch overflow-hidden rounded-[32px] bg-violet-50 p-12 pb-10 md:p-12"
        >
            <img
