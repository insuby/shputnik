...
export const FeedbackForm = () => {
  ...
  return (
    <div onClick={onBackdropClick} className={`fixed [font-family:var(--font-family)] z-50 inset-0 w-screen h-screen flex justify-center items-center p-[40px] transition-all duration-300 ease-in-out ${isVisible ? 'bg-[#000000CA] opacity-100' : 'bg-transparent opacity-0'}`}>
      <div className={`flex rounded-2xl flex-col h-fit w-fit items-start gap-6 p-6 relative bg-white overflow-hidden transition-all duration-300 ease-in-out transform ${isVisible ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 translate-y-4'}`}>
        <img
        ...
        <div className="flex items-start gap-[88px] p-[88px] relative self-stretch w-full flex-[0_0_auto] rounded-[32px] overflow-hidden">
          <div className="flex gap-[88px] flex-1 grow flex-col items-start relative">
            ...
            <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
              <div className="inline-flex gap-4 flex-[0_0_auto] flex-col items-start relative">
                <div className="relative w-[233px] mt-[-1.00px] font-header-2-m font-[number:var(--header-2-m-font-weight)] text-gray-40 text-[length:var(--header-2-m-font-size)] tracking-[var(--header-2-m-letter-spacing)] leading-[var(--header-2-m-line-height)] [font-style:var(--header-2-m-font-style)]">
                  +7 (495) 006-21-57
                </div>
          ...
          <div className="flex gap-10 p-12 flex-1 grow bg-[#f9fafd] rounded-[32px] flex-col items-start relative">
