...
export const DesktopLayout = () => {
  ...
  return (
    <>
      ...
      <div className="m-auto flex size-full max-w-[1440px] flex-col items-center overflow-hidden rounded-3xl px-3 ">
        <HeaderSection />
        <main id="content" className="size-full overflow-hidden">
          <Outlet />
        </main>
        <FooterSection />
      </div>
