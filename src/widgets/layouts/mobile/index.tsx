...
import { FeedbackForm, useFeedbackForm } from 'widgets';
            ...
            {menuPanel === 'root' && (
              <div className="absolute inset-x-3 bottom-2 m-auto h-[136px] rounded-[32px] bg-[#f9fafd] p-[8px_8px_8px_0]">
                <div className="size-full p-[16px_24px]">
                  ...
                  <p className="relative w-full pt-4 font-[number:var(--body-1-r-font-weight)] leading-[var(--body-1-r-line-height)] tracking-[var(--body-1-r-letter-spacing)] text-gray-40 [font-style:var(--body-1-r-font-style)] xl:w-[233px]">
                    {t('address', { ns: 'footer' })}
                  </p>
                </div>
              </div>
