...
export const Trust = () => {
    ...
    return (
        <div className="relative text-center w-full md:w-[1376px] rounded-[32px]">
            <div className="mx-auto flex w-full md:w-[704px] flex-col items-start gap-12">
            ...
            <Marquee fade innerClassName="!gap-32" className="!gap-32 md:py-20 py-8">
                <img
                    alt="Frame"
