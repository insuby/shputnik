...
export const RoleStructure = () => {
  ...
  return (
    <motion.div
      ...
      className="relative flex w-full flex-[0_0_auto] flex-col items-center gap-20 self-stretch px-0 xl:!flex-row xl:py-20"
    >
      <div className="relative flex w-full flex-col items-start gap-7 xl:w-[432px] xl:gap-12">
      ...
      <div className="relative flex flex-1 grow flex-col items-start justify-center gap-6 self-stretch xl:!flex-row">
        <motion.div
          ...
          className="relative flex flex-1 grow flex-col items-center justify-center gap-7 self-stretch overflow-hidden rounded-3xl bg-[#f9fafd] p-8 xl:p-10"
        >
