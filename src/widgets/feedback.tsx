...
export const Feedback = () => {
    ...
    return (
        <div
            className="relative flex w-full md:w-[1376px] !flex-[0_0_auto] flex-col items-start gap-2.5 rounded-[40px] bg-[#3573fc1f] p-3">
            <div
                className="relative flex w-full flex-[0_0_auto] items-center gap-2.5 self-stretch overflow-hidden rounded-[32px] bg-blue-50 p-[60px]">
                <img
                ...
                <div className="relative flex md:w-[696px] flex-col items-start gap-8">
                ...
                <motion.div
                    ...
                    className="md:inline-flex hidden absolute left-[789px] top-[65px]  flex-col items-start justify-center gap-4 rounded-[32px_32px_0px_0px] bg-white p-8"
                >
                    ...
                    >
                        ...
                        >
                            <div
                                className="relative h-[76px] w-2 rounded-3xl bg-[linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(0,203,130,1)_100%)]"/>

                            <div
                                className="relative w-11 text-center text-xs font-normal leading-4 tracking-normal text-[#7a86a2] [font-family:'Roboto',Helvetica]">
                                март
                            </div>
                        </motion.div>
                        ...
                        >
                            <div
                                className="relative h-[86px] w-2 rounded-3xl bg-[linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(0,203,130,1)_100%)]"/>
                        ...
                        >
                            <div
                                className="relative h-[105px] w-2 rounded-3xl bg-[linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(0,203,130,1)_100%)]"/>
                    ...
                    <div
                        className="absolute left-[156px] top-[133px] size-3 rounded-md border-2 border-solid border-[#00cb82] bg-[#ffffff]"/>
                </motion.div>
